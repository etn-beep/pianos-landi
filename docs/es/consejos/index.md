...
* Es recomendable controlar el porcentaje de humedad del aire mediante un higrómetro. La humedad relativa no debería ser inferior al 35 % ni superior al 65 %, siendo el valor ideal aproximadamente del 48 %.

* La temperatura ideal se sitúa entre 19 °C y 21 °C durante todo el año y, sobre todo, deben evitarse los cambios bruscos de temperatura. El instrumento debe colocarse al menos a 3 metros de cualquier fuente directa de calor y protegido de la luz solar directa.

* Si tiene problemas importantes relacionados con la humedad o la sequedad, considere la instalación de un [Dampp Chaser](../dampp-chaser/index.md); puede salvar su instrumento.
...
* Reserve un presupuesto para el mantenimiento. El piano debe afinarse cada año y, en ocasiones, también es necesario regularlo y armonizarlo.

* Prefiera los pianos más altos, ya que disponen de cuerdas más largas, lo que proporciona una mayor potencia sonora y una mejor calidad de sonido. Una altura de entre 1,10 m y 1,20 m suele ser una buena referencia.

* ATENCIÓN: ¡LA RESTAURACIÓN DE UN PIANO ANTIGUO EN MAL ESTADO PUEDE COSTAR MÁS QUE LA COMPRA DE UN PIANO NUEVO DE ESTUDIO!

* Infórmese bien antes de comprar un piano deteriorado que, supuestamente, «solo necesita una afinación».

* En muchos casos, es preferible adquirir un Kawai ND21 nuevo que invertir en una restauración incierta.
...
* Pianos coreanos: Samick, Young Chang, Hyundai...

* Pianos polacos: Legnica, Calisia.

* Pianos italianos: Furstein, Mussard.

* Pianos checos: Heineman, Hofmann, Rösler, Weinbach, Seidl & Sohn.

* Pianos ingleses: Kemble, Broadwood, Woodchester.

* Conviene saber que actualmente la mayoría de las marcas fabrican sus gamas de entrada en China o Indonesia.
